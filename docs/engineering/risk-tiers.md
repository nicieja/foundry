...
- **T0:** `docs/`, tests, scripts, comments, `.claude/agents`, `.claude/skills`, `.claude/commands`. Includes `docs/bets.md` and a new `docs/evidence/` bar, transcript, or verdict — writing one is free, changing one after it has been ruled is T3.
